...
public class FirstAlertActivity extends AppCompatActivity {
    ...
    public void etape2start(View view) {
        //send message
        FirebaseDatabase.getInstance().getReference().child("Database").child("User").child(idUser).child("numeros").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    ...
                    if(!text.equals("")){
                        text=text.replaceAll("de soupcon","d'urgence");
                    }
                    if(!num1.equals("")){
        ...
        firebaseDatabase.getReference("Database").child("Alert").child(idAlert).child("etapes").child("date_etape2").setValue(dateActu);
        firebaseDatabase.getReference("Database").child("Alert").child(idAlert).child("etat").setValue("Urgence");
        Intent intent=new Intent(this,SecondAlertActivity.class);
    ...
    public void etape3start(View view) {
        //send message
        FirebaseDatabase.getInstance().getReference().child("Database").child("User").child(idUser).child("numeros").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
